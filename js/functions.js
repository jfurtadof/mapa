...
/*function getCurrentLocation(tower, floor, block){
var pos_x = $('#map-image').css("left");
var pos_y = $('#map-image').css("top");
var zoom = $('#map-image').css("zoom");
zoom = zoom*100 + "%";
...
alert("PX: " + l + "L: " + t + "zoom: " + z);

if (pos_x != l && pos_y != t && zoom != z){
return true;
} else {
return false;
}
