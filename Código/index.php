...
<body>
  ...
  <div id="map">
    <div id="map-image">
      <div id="P1" class="map-image-floor">
        <?php
        include('./svgImage1.php');
        ?>
      </div>
      <div id="P2" class="map-image-floor">
        <?php
        include('./svgImage2.php');
        ?>
      </div>
      <div id="P3" class="map-image-floor">
        <?php
        include('./svgImage3.php');
        ?>
      </div>
      <div id="P4" class="map-image-floor">
        <?php
        include('./svgImage4.php');
        ?>
      </div>
      <div id="P5" class="map-image-floor">
        <?php
        include('./svgImage5.php');
        ?>
      </div>
      <div id="P6" class="map-image-floor">
        <?php
        include('./svgImage6.php');
        ?>
      </div>
    </div>
  </div>
